...
?>
    ...
    <head>
        <?php echo $twig->render('common/head.tpl'); ?>
            <title>Expert Articles | Daleel</title>
    </head>

    <body class="authorized">
        <?php echo $twig->render('common/header_logined.tpl'); ?>

            <div class="expert_intelligance inner_page ">
                    ...
                    <div class="container">
                        <div class="breadcrumbs_block row">
                            <ul class="breadcrumbs_list">
                                ...
                                <li class="breadcrumbs_list__item current"><span>Expert Intelligence</span></li>
                            </ul>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container">
                        ...
                        <?php echo $twig->render('common/filters.tpl'); ?>
                            ...
                            <div class="main_content_inner">
                                <div class="expert_intelligence_tiles_block">

                                    <?php echo $twig->render('common/expert_intelligance_tile.tpl'); ?>
                                        <?php echo $twig->render('common/expert_intelligance_tile.tpl'); ?>
                                            <?php echo $twig->render('common/expert_intelligance_tile.tpl'); ?>
                                                <?php echo $twig->render('common/expert_intelligance_tile.tpl'); ?>
                                                    <?php echo $twig->render('common/expert_intelligance_tile.tpl'); ?>
