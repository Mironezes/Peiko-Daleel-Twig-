<div class="suppliers_product_services_tile archived">
    <div class="suppliers_product_services_tile_inner">
        ...
        <div class="suppliers_product_services_body_edit">
            ...
            <a href="#" class="button button__view">
                <span>View</span>
            ...
            <a href="#" class="button button__edit button__yellow">
                <div class="button__icon">
            ...
            <a href="#" class="button button__archive icon_only has_tooltip">
                ...
                <span data-tooltip="Unarchive" class="tooltip tooltip__top"></span>
            </a>
            <a href="#" class="button button__delete icon_only has_tooltip">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="svg replaced-svg">
